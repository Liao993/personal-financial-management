...
class Expense(BaseModel):
    ...
    def category_in_list(cls, value):
        ...
        if value == "Not Categorized":
            raise ValueError(
                'Category must be defined, "Not Categorized" is not allowed.'
            )
    ...
    def traveling_category_in_list(cls, value):
        if value is not None and value not in traveling_category_options:
            raise ValueError(
                f"Traveling category must be one of {traveling_category_options}"
            )
        return value
    ...
    def category_traveling_check(cls, value, values):
        ...
        if value != "Traveling" and traveling_category is not None:
            raise ValueError(
                "If traveling_category is provided, category must be 'Traveling'"
            )
        return value
    ...
    def traveling_category_check(cls, value, values):
        ...
        if category == "Traveling" and value is None:
            raise ValueError(
                "If category is 'Traveling', traveling_category cannot be None"
            )
        return value
    ...
    def trip_check(cls, value, values):
        ...
        if value and category != "Traveling":
            raise ValueError(
                "If trip is provided, category must be 'Traveling'"
            )
        if category == "Traveling" and not value:
            raise ValueError(
                "If category is 'Traveling', trip cannot be empty"
            )
        return value
