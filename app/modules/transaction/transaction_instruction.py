...
def instruction():
    ...
    st.write("___")
    st.markdown(f"<p style='font-size: 20px;'>If I want to withdraw money from TFSA <b style='color:orange'>more than</b> the amount I deposited, please make a <b style='color:orange'>deposit</b> to that TFSA account for matching the total amouint. Interest earning don't need to record as earning.</p>", unsafe_allow_html=True)
